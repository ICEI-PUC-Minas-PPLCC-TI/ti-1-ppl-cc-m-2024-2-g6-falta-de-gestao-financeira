document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
      ...
      finalAmountField.textContent = `Montante final: R$ ${finalAmount.toFixed(2)}`;
    ...
    function loadSavedInvestments() {
      ...
      savedInvestments.forEach((investment, index) => {
        ...
        listItem.textContent = `Investimento ${index + 1}: R$ ${investment.valorInicial} + R$ ${investment.aporteMensal} mensal por ${investment.periodoMeses} meses a ${investment.taxaDeJuros}% de juros. Montante final: R$ ${investment.montanteFinal}`;
